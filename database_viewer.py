...
class SmartMonitoringApp:
    ...
    def _setup_modern_styles(self):
        ...
        self.root.configure(bg=self.theme_colors[self.current_theme]["bg"])
        
        # Notebook style
        self.style.configure("Modern.TNotebook", 
                           background=self.theme_colors[self.current_theme]["card"],
                           borderwidth=0,
                           tabmargins=[2, 5, 2, 0])
        ...
        self.style.map("Modern.TNotebook.Tab",
                      background=[("selected", self.theme_colors[self.current_theme]["accent"]),
                                 ("active", self.theme_colors[self.current_theme]["accent"])],
        ...
        self.style.configure("Modern.TButton",
                           ...
                           relief="flat",
                           borderwidth=0,
                           background=self.theme_colors[self.current_theme]["accent"],
                           foreground="#FFFFFF")
        self.style.map("Modern.TButton",
                      background=[("pressed", self.theme_colors[self.current_theme]["accent"]),
                                 ("active", self.theme_colors[self.current_theme]["accent"])])
        ...
        self.style.configure("Modern.TEntry",
                           ...
                           borderwidth=1,
                           relief="flat",
                           fieldbackground=self.theme_colors[self.current_theme]["card"])
        ...
        self.style.configure("Modern.Treeview",
                           background=self.theme_colors[self.current_theme]["card"],
                           fieldbackground=self.theme_colors[self.current_theme]["bg"],
                           foreground=self.theme_colors[self.current_theme]["fg"],
                           rowheight=28,
                           font=("Segoe UI", 9))
    ...
    def _build_table_viewer(self, parent):
        ...
        self.table_tree.pack(fill="both", expand=True, padx=2, pady=2)
        ...
        ttk.Label(status_frame, textvariable=self.status_var, style="Modern.TLabel",
                 anchor="w", padding=8).pack(fill="x")

    def _build_user_logins(self, parent):
        self.login_tab = parent
        ttk.Label(parent, text="🔐 User Login Records", 
                style="Modern.TLabel", font=("Segoe UI", 14, "bold")).pack(pady=(10, 5))
    ...
    def _build_stats_tab(self, parent):
        ...
        # Initialize all required figure and canvas attributes
